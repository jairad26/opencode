...
const InfoSchema = Schema.Struct({
  ...
  experimental: Schema.optional(
    Schema.Struct({
      ...
      swarm_concurrency: Schema.optional(PositiveInt.check(Schema.isLessThanOrEqualTo(10))).annotate({
        description: "Maximum number of concurrent sub-agents to spawn in a single swarm call",
      }),
    }),
  ),
})
